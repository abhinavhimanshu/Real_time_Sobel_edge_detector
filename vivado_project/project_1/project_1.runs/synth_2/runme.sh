...
HD_PWD='/nethome/ahimanshu3/DSP_Project/PROJECT_WORKING/Vga_projrct/project_1/project_1.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Our_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Our_design.tcl
