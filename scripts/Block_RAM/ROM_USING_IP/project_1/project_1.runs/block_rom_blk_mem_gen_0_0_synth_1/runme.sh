...
HD_PWD='/nethome/ahimanshu3/DSP_Project/Block_RAM/vivado_IP_TEST/project_1/project_1.runs/block_rom_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_rom_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_rom_blk_mem_gen_0_0.tcl
