...
HD_PWD='/nethome/ahimanshu3/DSP_Project/PROJECT_WORKING/Vga_projrct/project_1/project_1.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Our_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Our_design.tcl -notrace
