...
################################################################
# This is a generated script based on design: clk_25
#
...
CONFIG.FREQ_HZ {25000000} \
  ...
  set clk_source [ create_bd_port -dir O -type clk clk_source ]
...
CONFIG.CLK_OUT2_PORT {clk_source} \
...
CONFIG.USE_RESET {false} \
  ...
  connect_bd_net -net clk_wiz_0_clk_source [get_bd_ports clk_source] [get_bd_pins clk_wiz_0/clk_source]
